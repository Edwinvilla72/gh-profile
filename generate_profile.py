...
INFO = [
    ...
    ("Recognition", "UCF CECS Senior Design Showcase finalist", "val"),
    ("Leadership", "Project Manager on Intelligent Browser Agents", "val"),
    # ("__stats__", "", ""),
    ("__blank__", "", ""),
    
    ("__section__", "~/reach", ""),
    ("Web",      "Edwingabriel.com", "accent"),
    ("LinkedIn",       "linkedin.com/in/edwin-villanueva", "accent"),
