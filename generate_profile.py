...
INFO = [
    ("__header__", "Edwin Gabriel Villanueva", ""),
    ("__rule__", "", ""),
    ("Role",     "Full Stack Engineer @ Entertainment Technology Partners", "val"),
    ("Edu",      "B.S. Computer Science, UCF '26", "val"),
    ("Focus",    "Full-stack systems, AI agents, LLM apps", "accent"),
    ("__blank__", "", ""),
    
    ("__section__", "~/stack", ""),
    ("Languages", "C, Python, TypeScript, JavaScript, SQL, C++, Java", "val"),
    ("Backend",   "FastAPI, Node.js/Express, Next.js, REST APIs", "val"),
    ("AI",        "LLM APIs, LangGraph, Agent Systems", "val"),
    ("Infra",     "AWS, Docker, Linux, CI/CD, SAM CLI", "val"),
    ("Data",      "PostgreSQL, MongoDB, DynamoDB", "val"),
    ("__blank__", "", ""),
    
    ("__section__", "~/projects", ""),
    ("IBA (SD)",     "Multi-agent browser task automation tool", "warn"),
    ("",         "IBA = Intelligent Browser Agents", "muted"),
    ("knw. (ETP)", "Gain insights on audience engagement", "warn"),
    ("FuelWatch", "CrewAI theft detection, 97% accuracy", "warn"),
    ("MediGuide", "Health assistant published in Springer LNNS", "warn"),
    ("__blank__", "", ""),
    
    ("__section__", "~/highlights", ""),
    ("Award",    "UCF CECS Senior Design Showcase finalist", "val"),
    ("__stats__", "", ""),
    ("__blank__", "", ""),
    
    ("__section__", "~/reach", ""),
    ("Web",      "Edwingabriel.com", "accent"),
    ("In",       "linkedin.com/in/edwin-villanueva", "accent"),
    ("Mail",     "Edwin.villa2@icloud.com", "accent"),
    ("__rule__", "", ""),
]
...
def render(theme_name, colors, stats, ist_now):
    ...
    parts.append(
        ...
        f'<tspan class="key">➜</tspan>'
        f'<tspan class="acc" dx="8">~</tspan>'
        f'<tspan class="val" dx="8">open to software engineer and full-stack roles</tspan>'
